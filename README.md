...
This README describes the real architecture behind the tool, with internal URLs, credentials, and infrastructure identifiers redacted/genericized. It documents a pattern, not a runnable standalone repo — see A note on reuse.
...
Spike
Maturation
Any type containing "opportunit"
Maturation
Story
Build
Subtask / Sub-task
...
GET /api/ps-timesheet/pivot?startMonth&endMonth

cache read/write, 30 min TTL

worklog queries, service account
